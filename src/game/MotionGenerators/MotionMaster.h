...
class MotionMaster : private std::stack<MovementGenerator*>
{
    ...
    public:
        ...
        void MoveJump(float x, float y, float z, float horizontalSpeed, float maxHeight, uint32 id = EVENT_JUMP, bool orientationFixed = false);
        ...
        void MoveJumpFacing(Position pos, float horizontalSpeed, float maxHeight, uint32 id = EVENT_JUMP, ObjectGuid guid = ObjectGuid(), uint32 relayId = 0, bool orientationFixed = false);
