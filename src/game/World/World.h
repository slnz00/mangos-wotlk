...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_DROP_MIN_ITEMS_NORMAL,
    CONFIG_UINT32_DROP_MIN_ITEMS_ELITE,
    CONFIG_UINT32_DROP_MIN_ITEMS_BOSS,
    CONFIG_UINT32_DROP_MIN_ITEMS_RARE,
    CONFIG_UINT32_DROP_MAX_ITEMS_NORMAL,
    CONFIG_UINT32_DROP_MAX_ITEMS_ELITE,
    CONFIG_UINT32_DROP_MAX_ITEMS_BOSS,
    CONFIG_UINT32_DROP_MAX_ITEMS_RARE,
    CONFIG_UINT32_CREATURE_AUTOSCALE_PLAYERS_THRESHOLD,
    CONFIG_UINT32_CREATURE_AUTOSCALE_MIN_PLAYER_LEVEL,
    CONFIG_UINT32_CREATURE_AUTOSCALE_DOWNSCALE_DELAY,
    CONFIG_UINT32_SKILL_GAIN_HERBALISM,
    CONFIG_UINT32_SKILL_GAIN_SKINNING,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_SCALE_NORMAL_DAMAGE,
    CONFIG_FLOAT_SCALE_NORMAL_HEALTH,
    CONFIG_FLOAT_SCALE_RARE_DAMAGE,
    CONFIG_FLOAT_SCALE_RARE_HEALTH,
    CONFIG_FLOAT_SCALE_INSTANCE_DAMAGE,
    CONFIG_FLOAT_SCALE_INSTANCE_HEALTH,
    CONFIG_FLOAT_DOUBLE_DROP_CHANCE_NORMAL,
    CONFIG_FLOAT_DOUBLE_DROP_CHANCE_ELITE,
    CONFIG_FLOAT_DOUBLE_DROP_CHANCE_RARE,
    CONFIG_FLOAT_DOUBLE_DROP_CHANCE_BOSS,
    CONFIG_FLOAT_DROP_MIN_CHANCE_NORMAL,
    CONFIG_FLOAT_DROP_MIN_CHANCE_ELITE,
    CONFIG_FLOAT_DROP_MIN_CHANCE_RARE,
    CONFIG_FLOAT_DROP_MIN_CHANCE_BOSS,
    CONFIG_FLOAT_XP_AUTOSCALE_FACTOR_KILL,
    CONFIG_FLOAT_XP_AUTOSCALE_FACTOR_QUEST,
    CONFIG_FLOAT_CREATURE_AUTOSCALE_DISTANCE_MAX,
    CONFIG_FLOAT_CREATURE_AUTOSCALE_DISTANCE_COMBAT,
    CONFIG_FLOAT_CREATURE_AUTOSCALE_RATE_NORMAL_HEALTH,
    CONFIG_FLOAT_CREATURE_AUTOSCALE_RATE_NORMAL_DAMAGE,
    CONFIG_FLOAT_CREATURE_AUTOSCALE_RATE_RARE_HEALTH,
    CONFIG_FLOAT_CREATURE_AUTOSCALE_RATE_RARE_DAMAGE,
    CONFIG_FLOAT_CREATURE_AUTOSCALE_RATE_INSTANCE_HEALTH,
    CONFIG_FLOAT_CREATURE_AUTOSCALE_RATE_INSTANCE_DAMAGE,
    CONFIG_FLOAT_RATE_DROP_AMOUNT_ITEM_QUEST_MIN,
    CONFIG_FLOAT_RATE_DROP_AMOUNT_ITEM_QUEST_MAX,
    CONFIG_FLOAT_RATE_FISHING_CHANCE,
    CONFIG_FLOAT_PRIEST_ATONEMENT_DISTANCE,
    CONFIG_FLOAT_PRIEST_ATONEMENT_MULTI_0,
    CONFIG_FLOAT_PRIEST_ATONEMENT_MULTI_10,
    CONFIG_FLOAT_PRIEST_ATONEMENT_MULTI_20,
    CONFIG_FLOAT_PRIEST_ATONEMENT_MULTI_30,
    CONFIG_FLOAT_PRIEST_ATONEMENT_MULTI_40,
    CONFIG_FLOAT_PRIEST_ATONEMENT_MULTI_50,
    CONFIG_FLOAT_PRIEST_ATONEMENT_MULTI_60,
    CONFIG_FLOAT_PRIEST_ATONEMENT_MULTI_70,
    CONFIG_FLOAT_PRIEST_ATONEMENT_MULTI_80,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_XP_AUTOSCALE,
    CONFIG_BOOL_CREATURE_AUTOSCALE_WORLD,
    CONFIG_BOOL_CREATURE_AUTOSCALE_INSTANCE,
    CONFIG_BOOL_GROUP_ROLL_IN_FFA,
