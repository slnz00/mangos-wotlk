...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_DOUBLE_DROP_CHANCE_NORMAL,
    CONFIG_UINT32_DOUBLE_DROP_CHANCE_ELITE,
    CONFIG_UINT32_DOUBLE_DROP_CHANCE_RARE,
    CONFIG_UINT32_DOUBLE_DROP_CHANCE_BOSS,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_SCALE_DEFAULT_DAMAGE,
    CONFIG_FLOAT_SCALE_DEFAULT_HEALTH,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_INSTANCE_AUTO_SCALE,
